...
class EmpleadoAuthMiddleware
{
    public function __invoke(Request $request, RequestHandler $handler):Response
    {
        ...
        try {
            ...
            //var_dump($decoded);
            if($decoded->tipo == 'mozo' || $decoded->tipo == 'cocinero' || $decoded->tipo == 'cervezero' || $decoded->tipo == 'bartender'){
        ...
        if(!$valido)
        {
            ...
            $response->getBody()->write("TOKEN O AUTENTICACION INVALIDA, NO ES SOCIO");
